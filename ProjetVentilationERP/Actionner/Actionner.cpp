/****************************************************************************
 *  Fichier:  Actionner.cpp
 *  Projet:   ProjetERP
 *  Crée le:  12/05/2025
 * 	Version:  1.0
 *  Utilité:  Permet de faire sortir un signal PWM en rentrant une puissance en pourcentage
...
int main()
{
    ...
    int pourcentage;
    std::cout << "Entrez une puissance (1 à 100 %) : "; //Normalement depuis la BDD
    std::cin >> pourcentage;
    ...
    int freq = 1000; // 1 kHz
    int rapport = (pourcentage * 255) / 100; // pigpio utilise 0-255
